...
final class SkjJabatanTable extends PowerGridComponent
{
  public string $tableName = 'skj-jabatan-table';
  ...
  public function datasource(): Builder
  {
    return Position::query()
      ->with(['unit', 'root_unit'])
      ->where('occupation_type_code', $this->occupation_type->code);
  }
  ...
  public function fields(): PowerGridFields
  {
    return PowerGrid::fields()
      ...
      ->add('code')
      ->add('name')
      ->add('skpd_name', fn($row) => $row->root_unit?->name)
      ->add('created_at');
  }
  ...
  public function columns(): array
  {
    return [
      Column::make('Nama Jabatan', 'name')
        ...
        ->sortable()
        ->searchable(),
      Column::make('Nama SKPD', 'skpd_name')
        ->contentClasses('inline-block pt-1'),
  ...
  public function actions(Position $row): array
  {
    ...
    if (!$row->hasMedia('skj')) {
      ...
      $downloadBtn->dispatch('show-modal', [
        ...
        'component' => 'modal.skj-jabatan-list-preview',
