...
class MyTheme extends Tailwind
{
  ...
  public function table(): array
  {
    return [
      ...
      'body' => [
        ...
        'td'                 => 'px-3 py-2 whitespace-nowrap dark:text-pg-primary-200 align-top',
  ...
  {
    return [
      'th'    => 'px-6 py-3 text-left text-xs font-medium text-pg-primary-500 tracking-wider align-top',
      'base'  => '',
