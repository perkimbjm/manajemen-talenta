...
>
 ...
 <div class="form-control w-full">
  ...
  <div
   ...
   x-show="!!$wire.supportingTask_document_id"
   x-transition
  >
   <a
    href="/files/local/{{ $supportingTask_document?->id }}/{{ $supportingTask_document?->file_name }}"
    class="link text-primary"
    target="_blank"
   >
    {{ $supportingTask_document?->name }}
   </a>
   ...
   <button
    ...
    x-on:click="() => {
        $dispatch('confirm-modal', {
          ...
          confirmAction: () => $wire.supportingTask_document_id = null,
        })
       }"
   >
