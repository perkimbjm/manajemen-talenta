...
<div class="mx-auto max-w-screen-xl px-4 py-4 sm:px-6">
 <article class="card card-bordered card-compact bg-white">
  <div
   class="card-body"
   x-on:delete-employee="(ev) => {
    console.log('🚀 ~ ev:', ev)
    $dispatch('confirm-modal', {
      content: 'Apakah anda yakin akan menghapus data pegawai ini?',
      confirmAction: () => $wire.deleteEmployee(ev.detail.id)
    })
   }"
  >
