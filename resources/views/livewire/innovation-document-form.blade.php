...
>
 <label class="form-control w-full">
  <div class="label">
   <span class="label-text">Nama Inovasi</span>
  </div>
  <input
   type="text"
 ...
 <div class="form-control w-full">
  ...
  <div
   ...
   x-show="!!$wire.innovation_document_id"
   x-transition
  >
   <a
    href="/files/local/{{ $innovation_document?->id }}/{{ $innovation_document?->file_name }}"
    class="link text-primary"
    target="_blank"
   >
    {{ $innovation_document?->name }}
   </a>
   ...
   <button
    ...
    x-on:click="() => {
        $dispatch('confirm-modal', {
          ...
          confirmAction: () => $wire.innovation_document_id = null,
        })
       }"
   >
